...
If you have been away from this course for a time, It may be best to re-start earlier-on where 'Local' is introduced, approx 1.58 in, just to familiarise yourself with what you have been doing leading up to adding your own theme. 

The file named '0.1_Local_WP' shows instructions on how to add a wordpress site to the downloaded local software. 
...
0.3Boilerplate.c (Shows contents of files)
